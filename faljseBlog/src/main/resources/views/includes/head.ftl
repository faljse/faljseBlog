...
<head>
    ...
    <script src="${basePath}assets/prettify/run_prettify.js"></script>

    <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
    <!--[if lt IE 9]>
    <script src="${basePath}/assets/ie/html5shiv.js"></script>
    <script src="${basePath}/assets/ie/respond.min.js"></script>
    <![endif]-->
</head>